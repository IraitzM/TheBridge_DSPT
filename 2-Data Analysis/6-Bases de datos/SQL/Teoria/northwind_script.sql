-- Puedes:
--     Abrir una solución como DBeaver
--     Crear una base de datos SQLLite llamada Northwind
--     Seleccionar ejecutar SQL
--     Copiar y pegar este código
--     Y ejecutar el script
-- O:
--     Ejecutar el notebook adjunto: 2-Trabajando con una base de datos.ipynb
